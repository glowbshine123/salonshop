        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex-1 flex items-center justify-start">
            ...
            <div className="hidden md:block">
              <Link to="/" className="flex items-center gap-2 group">
                <div className="h-12 sm:h-14 flex items-center justify-center transition-transform">
                  <img src="/SCRAB%20LOGO.png" alt="Logo" className="w-full h-full object-contain drop-shadow-lg" />
                </div>
              </Link>
            </div>
          </div>
          ...
          <div className="flex-1 flex items-center justify-center md:hidden">
            <Link to="/" className="flex items-center group">
              <div className="h-10 flex items-center justify-center transition-transform">
